...
class ByeDpiProxyService : LifecycleService() {
    ...
    private suspend fun start() {
        ...
        sessionSocksPort = LocalSocksPort.allocate()
    ...
    private suspend fun startProxy() {
        ...
        proxy = ByeDpiProxy()
        val preferences = getByeDpiPreferences(sessionSocksPort)
    ...
    private fun getByeDpiPreferences(socksPort: Int): ByeDpiProxyPreferences =
        ByeDpiProxyPreferences.fromSharedPreferences(getPreferences(), socksPort)
